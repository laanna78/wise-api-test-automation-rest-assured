...
public class TcWiseBal02Test extends BaseOfWiseTests {
    ...
    @Test(description = "TC-WISE-BAL-02: USD egyenleg lekérése")
    ...
    public void getUSDBalanceTest() {
        ...
        Allure.step("Lépés 3: Egyenleg adatok és USD pénznem validálása", () -> {
            ...
            ConfigReader.setProperty("usd_balance_before", amountValue.setScale(2, RoundingMode.HALF_UP).toString());

            logger.info("USD egyenleg adatok sikeresen validálva. Az USD számla kiinduló egyenlege: {}", amountValue);
        });
    }
}
