...
public class TcWiseFx03Test extends BaseOfWiseTests {
    ...
    @Test(description = "TC-WISE-FX-03: Azonos devizák közötti átvezetés")
    ...
    public void sameCurrencyQuoteTest() {
        ...
        Allure.step("Lépés 3: Árfolyam és díjmentesség validálása", () -> {
            ...
            Assert.assertEquals(rate.compareTo(BigDecimal.ONE), 0, "Azonos devizák esetén az árfolyamnak 1.0-nak kell lennie!");
            ...
            Assert.assertEquals(totalFee.compareTo(BigDecimal.ZERO), 0,
            ...
            Assert.assertEquals(source.compareTo(target), 0, "Díjmentes átvezetésnél a forrás és cél összegnek meg kell egyeznie!");
        });
